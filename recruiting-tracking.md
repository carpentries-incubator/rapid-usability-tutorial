...
![](fig/ep3_folders.png){alt='Two screenshots of different Google Drive folders with annotations indicating which content should be shared and which should be confidential. Raw data and the participant tracker are marked confidential.'}
